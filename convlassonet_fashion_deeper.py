...
# parser.add_argument('--l1', type=float, default=1e1, help='Lambda for regularizer')
# parser.add_argument('--M', type=float, default=1e0, help='M hyperparameter from LassoNet... In reailty it just sets ceiling in ConvLassoNet')
...
root_path = "/cluster/projects/radiomics/Temp/sejin/LassoNet"
...
class FashionMNISTDataset(FashionMNIST):
    def __init__(self, train: bool=True):
        super().__init__(root_path, train, download=True)
